    ...
    <>
      ...
      <div className="pb-20 pt-20 relative flex flex-col lg:flex-row px-20">
        ...
        <div className="w-1/2 space-y-5 z-20">
          <p className="font-bold text-6xl">Join the 2000+ Resumo family</p>
